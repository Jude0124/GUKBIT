...
public class BoardController {
    ...
    @ResponseBody
    public String replyDeleteMapping(@AuthenticationPrincipal CustomUserDetails customUserDetails, @RequestBody JSONObject jsonObject) {
        String rAuthor = (String) jsonObject.get("rAuthor");

        if(customUserDetails.getUser().getUserId().equals(rAuthor)){
